...
export const mockData = {
  board: {
    _id: 'board-id-01',
    title: 'TienDatCode MERN Stack Board',
    ...
    columns: [
      ...
      },
      {
        ...
        cards: [
          { _id: 'column-id-04-placeholder-card', boardId: 'board-id-04', columnId: 'column-id-04',
            FE_PlaceholderCard:true // EmptyColumn sẽ chưá 1 card có id : column-id-**-placeholder-card để giữ chố
          }
        ]
      }
    ]
